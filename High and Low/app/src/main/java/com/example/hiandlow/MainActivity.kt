...
class MainActivity : AppCompatActivity() {
    ...
    private fun showDroidCard() {
        when (droidCard) {
            1 -> droidCardImage.setImageResource(R.drawable.d01)
            2 -> droidCardImage.setImageResource(R.drawable.d02)
            3 -> droidCardImage.setImageResource(R.drawable.d03)
            4 -> droidCardImage.setImageResource(R.drawable.d04)
            5 -> droidCardImage.setImageResource(R.drawable.d05)
            6 -> droidCardImage.setImageResource(R.drawable.d06)
            7 -> droidCardImage.setImageResource(R.drawable.d07)
            8 -> droidCardImage.setImageResource(R.drawable.d08)
            9 -> droidCardImage.setImageResource(R.drawable.d09)
            10 -> droidCardImage.setImageResource(R.drawable.d10)
            11 -> droidCardImage.setImageResource(R.drawable.d11)
            12 -> droidCardImage.setImageResource(R.drawable.d12)
            13 -> droidCardImage.setImageResource(R.drawable.d13)
        }
    }
}
